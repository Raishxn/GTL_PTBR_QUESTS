...
PlayerEvents.loggedIn(event => {
    ...
    player.tell("§7================================================")
    player.tell("§aWelcome to \"§r§eHard Drive Savior§r§a\"!")
    player.tell("The current version of §a is §r §ev21")
    player.tell("§cThe current version is not perfect and may have many bugs!")
    player.tell("§a This private product comes with a mission statement, please read it carefully.")
    ...
    player.tell("§c⚠️This private product needs to open the original void mining machine in GTL core, otherwise an error will be reported! ! !")
    player.tell("§e I wish you a happy game!")
    player.tell("§7================================================")
})
