...
title: Seth Quartz Decorative Squares
  icon: quartz_stairs
  position: 010
categories:
...
# Seth Quartz Decorative Squares
...
<ItemLink id="quartz_block" /> can be crafted into decorative building blocks by crafting, smelting or cutting stone.
