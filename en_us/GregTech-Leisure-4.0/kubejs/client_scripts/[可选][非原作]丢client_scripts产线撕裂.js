...
JEIEvents.addItems(event => {
    ...
    event.add(Item.of('gtladditions:macro_atomic_resonant_fragment_stripper', '{BlockEntityTag:{astralArrayCount:382},display:{Lore:[\'"The macroatom of the paradox realization theory has been unlocked and 382 star arrays have been stuffed into it. As a host, you can obtain Long.MAXin parallel by combining it with the Eternal Coil."\']}}'))
