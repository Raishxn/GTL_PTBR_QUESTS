...
ServerEvents.recipes(function(event) {
    ...
    if (enabled) {
        console.log("[Path of the False God·Hide] has been turned on, hiding will not be performed");
        return;
    }
    console.log("[Path of the False God·Hidden] has not been opened, and the recipe has been removed...");
    ...
    console.log("[Path of the False God·Hidden] Recipe removal completed");
});