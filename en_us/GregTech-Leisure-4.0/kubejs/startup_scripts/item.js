...
StartupEvents.registry("item", event => {
    ...
    tiers.forEach((universal_circuit) => {
        event.create(universal_circuit + "_universal_circuit")
            ...
            .displayName(universal_circuit.toUpperCase() + "Universal circuit board")
            .tooltip("§7a general circuit board")
    })
    ...
    event.create("hui_circuit_1")
        .tooltip(Component.literal("§793015-T floating point operations/second"))
    event.create("hui_circuit_2")
        .tooltip(Component.literal("§776M processing unit"))
    event.create("hui_circuit_3")
        .tooltip(Component.literal("§7invalid RSA algorithm"))
    event.create("hui_circuit_4")
        .tooltip(Component.literal("§756th Mersenne Prime"))
    event.create("hui_circuit_5")
        .tooltip(Component.literal("§7Paradox"))
