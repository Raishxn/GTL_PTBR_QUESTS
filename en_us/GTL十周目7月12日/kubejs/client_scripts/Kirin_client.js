                ...
                if (KIRIN_CONFIG.enableSafeFixes) {
                    ...
                    event.addAdvanced(autoConfigurationParallelHatchList, (item, advanced, text) => {
                        ...
                        if (item.nbt) {
                            ...
                            text.add(Text.green('✨Prefabricated multiplier maintenance bins can be made in the synthesis bar or assembly machine, eliminating the trouble of manual adjustment!'))
                ...
                if (KIRIN_CONFIG.enableSignificantBalanceChanges) {
                    ...
                    event.addAdvanced('gtceu:void_fluid_drilling_rig', (item, advanced, text) => {
                        ...
                        if (event.shift) {
                            ...
                            text.add(Text.gold('Endless Fluid Rig: 6144x'))
                    ...
                    event.addAdvanced(Ingredient.of(/gtceu:.*_laser_engraver/).or('gtceu:large_engraving_laser').or('gtceu:dimensional_focus_engraving_array').or('gtceu:engraving_laser_plant').or('gtladditions:lucid_etchdreamer'), (item, advanced, text) => {
						...
						text.add(Text.gold('✨Dimensional focused laser etching array no longer requires photoresist to engrave low-level wafers, and it no longer requires computing power and research to engrave high-level wafers'))
