...
JEIEvents.addItems(event => {
    ...
    event.add(Item.of('gtladditions:macro_atomic_resonant_fragment_stripper', '{BlockEntityTag:{astralArrayCount:382},display:{Lore:[\'"The macroatom that has unlocked the paradox realization theory has stuffed 382 star arrays. When used as a host, it can be obtained by combining with the eternal coil. Long. MAX parallel"\']}}'))
    event.add(Item.of('gtceu:configurable_maintenance_hatch', '{BlockEntityTag:{ durationMultiplier:2.0f, maintenanceProblems:127b },display:{Lore:[\'"The time-consuming multiplier is 2.0x. It has been maintained once. Place it carefully. The maintenance status and time-consuming multiplier will be reset after mining"\']}}'))
    event.add(Item.of('gtceu:auto_configuration_maintenance_hatch', '{BlockEntityTag: {durationMultiplier:2.0f},display:{Lore:[\'"The time-consuming multiplier is 2.0x. Place it carefully. The time-consuming multiplier will be reset after mining"\']}}'))
    // --- 批量注册无限原木单元 ---
