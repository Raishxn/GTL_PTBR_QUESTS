StartupEvents.registry('item', event =>{
    ...
    const moduletip = 
    [
        '§7False secret module',
        '§7 The first time I came into contact with Tianji, I finally failed.',
        '§7This fragile single-material shell cannot fit it in',
        '§7Although you still can\'t bear the secret, you know that you are very close to success.',
        '§7 Yes, the high-strength titanium withstood the bombardment of this space machine.',
        '§2 Electronic extension, one step further',
        '§2 High-precision electronic components have reached a realistic level',
        '§2 Quantum ghosts have restrained a few secrets of heaven',
        '§2Using ordinary crystals to make the body out of shell',
        '§dBeyond ordinary, more powerful than the mere fusion of flesh and electrons',
        '§dPut the ecology into the module and empower it with the secret of heaven',
        '§d Photon is 01. Deelectrify to grid objects',
    ...
    const moremodule=[
        ...
        {path:'fishbig_process_module_p1',name:'Motor de bloco de construção de peixe',tip:'§7??? módulo de nível usado para criar grandes componentes de peixe'},
        ...
        {path:'fishbig_process_module_p4',name:'Bloco de construção de peixe - mecanismo desconhecido',tip:'§7??? módulo de nível usado para criar grandes componentes de peixe'},
