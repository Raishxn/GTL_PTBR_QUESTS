...
gtr.assembler('disksavior:ID personalizado')
    .itemInputs('Quantidade x Item')
    .inputFluids('Quantidade de fluido')
    .itemOutputs('Quantidade x itens de saída')
    .outputFluids('Quantidade de fluido')
...
PlayerEvents.loggedIn(event => {
    ...
    player.tell("§7================================================")
    player.tell("§aBem-vindo ao usar \"§r§eDisco Rígido Salvador §r§a\"!")
    player.tell("A versão atual do §aé §r§ev21")
    player.tell("§cA versão atual não é perfeita e pode conter muitos bugs!")
    player.tell("§aEste produto privado vem com uma declaração de missão, leia-a com atenção.")
    player.tell("§c⚠️Pobre compatibilidade com a versão privada GTL!")
    player.tell("§c⚠️Se você não instalar adições GTL, poderá receber um erro!")
    player.tell("§c⚠️Este produto privado precisa habilitar a máquina de mineração vazia original no núcleo GTL, caso contrário, um erro será relatado!!!")
    player.tell("§eDesejo-lhe um feliz jogo!")
    player.tell("§7================================================")
})
