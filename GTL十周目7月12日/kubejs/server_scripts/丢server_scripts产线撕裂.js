...
ServerEvents.recipes((event) => {
    ...
    event.shapeless(packed_infinity_cell('Pacote de componentes de ferramentas frágeis','i',['fragile_tool:fragile_file', 'fragile_tool:fragile_hammer', 'fragile_tool:fragile_mallet', 'fragile_tool:fragile_wrench', 'fragile_tool:fragile_wire_cutter', 'fragile_tool:fragile_crowbar', 'fragile_tool:fragile_saw', 'fragile_tool:fragile_screwdriver','fragile_tool:fragile_knife','fragile_tool:fragile_mortar']),
    ...
    .itemOutputs(Item.of('gtceu:configurable_maintenance_hatch', "{BlockEntityTag:{durationMultiplier:2.0f,maintenanceProblems:127b},display:{Lore:['\"O multiplicador demorado é 2,0x. Foi mantido uma vez. Coloque-o com cuidado. O status de manutenção e o multiplicador demorado serão redefinidos após a mineração.\"']}}"))
    ...
    .itemOutputs(Item.of('gtceu:auto_configuration_maintenance_hatch', "{BlockEntityTag: {durationMultiplier:2.0f},display:{Lore:['\"O multiplicador demorado é 2,0x. Coloque-o com cuidado. O multiplicador demorado será redefinido após a mineração\"']}}"))
...
*/
   ...
   gtr.alloy_blast_smelter('thetornproductionline:easier_quantanium')//炖量子
    ...
    const homoitem=["gtceu:carbon_dust",
        ...
        .EUt(4000000000000000000)
            ...
            gtr.qft("thetornproductionline:ultimate_false_cosmos_simulation")//add版究极量子模拟
                ...
                .itemOutputs(packed_infinity_cell_if('Pacote de componentes Hongmeng',homoitem,homofluid))
                .duration(20)
                .EUt(2147483648)
            gtr.assembler('kubejs:ultimate_gas_collect')//究极集气
                ...
                .itemOutputs(packed_infinity_cell('Pacote de componentes de coleta de gás','f',['gtceu:air','gtceu:liquid_air','gtceu:nether_air','gtceu:liquid_nether_air','gtceu:ender_air','gtceu:liquid_ender_air']))
                .duration(20)
                .EUt(GTValues.VA[GTValues.UXV])
        if(Platform.isLoaded('gtl_extend'))
        {
            ...
            .itemOutputs(packed_infinity_cell_if('Pacote de componentes do buraco negro',homoitem,bhmdo))
            .duration(20)
            .EUt(2147483648)
        }
    ...
    gtr.assembly_line('thetornproductionline:ultimate_space_probe')//究极宇宙探测
        ...
        .itemOutputs(packed_infinity_cell('Pacote de componentes de exploração espacial','f',['gtceu:cosmic_element','gtceu:starlight','gtceu:heavy_lepton_mixture']))
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(20)
    ...
    gtr.suprachronal_assembly_line('thetornproductionline:ultimate_petrochemical_plant_and_wood_distillation')//究极木石化
        ...
        .itemOutputs(packed_infinity_cell('Pacote de componentes de madeira petrificada','f',['gtceu:ethanol','gtceu:naphthalene','gtceu:octane', 'gtceu:ethane', 'gtceu:propane', 'gtceu:butane', 'gtceu:toluene', 'gtceu:benzene', 'gtceu:butadiene', 'gtceu:butene', 'gtceu:propene', 'gtceu:ethylene', 'gtceu:methanol', 'gtceu:absolute_ethanol', 'gtceu:methane', 'gtceu:methyl_acetate', 'gtceu:acetic_acid', 'gtceu:carbon', 'gtceu:creosote', 'gtceu:carbon_monoxide', 'gtceu:dimethylbenzene', 'gtceu:acetone', 'gtceu:phenol']))
        .EUt(GTValues.VA[GTValues.MAX])
        .duration(20)
    ...
    gtr.large_chemical_reactor('thetornproductionline:easier_osmium_tetroxide_dust')//四氧化锇单步
        ...
        .EUt(GTValues.VA[GTValues.LV])
        .duration(80)
    gtr.assembly_line('thetornproductionline:creative_computation_provider')//如果你厌倦了超级计算机的'Baixo'算力
    ...
    .itemOutputs(Item.of('gtladditions:macro_atomic_resonant_fragment_stripper', '{BlockEntityTag: {astralArrayCount:382},display:{Lore:[\'"O átomo macro da teoria da realização do paradoxo foi desbloqueado e 382 matrizes de estrelas foram inseridas nele. Quando usado como hospedeiro, o paralelo Long. MAX é obtido pela combinação com a bobina eterna"\']}}'))
    .duration(114514)
    .EUt(2147483648)
    .circuit(2)
})  
