...
ServerEvents.recipes(function(e) {
    ...
    // 日志函数（本地定义，避免跨文件依赖）
    var LOG_PREFIX = '§b[biblioteca de fórmulas Shanhai] §r';
    ...
    var info = function(m) { console.log(getTimestamp() + ' §a[INFO]§r ' + LOG_PREFIX + ' ' + m); };
    var warn = function(m) { console.log(getTimestamp() + ' §e[WARN]§r ' + LOG_PREFIX + ' ' + m); };
    var error = function(m) { console.log(getTimestamp() + ' §c[ERROR]§r ' + LOG_PREFIX + ' ' + m); };

    // 从 global 导入山海私货API（由 山海的big私货.js 提供）
    var getShanhaiPackNBT = global.getShanhaiPackNBT;
    var DShanhaiSDA = global.DShanhaiSDA;
    var packed_cell_nbt2 = global.packed_cell_nbt2;
        ...
        try {
            ...
            if (typeof arg1 === 'string' && typeof arg2 === 'string' && typeof arg3 === 'function') {
                ...
                if (!engineIsRecipeEnabled(arg2, recipeObj.defaultEnabled, recipeLoadConfig)) {
                    DShanhaiRecipeEngine.recordSkippedRecipe(arg1, arg2, 'Carregamento de receita desativado, ignorado');
                    return true;
                }
                try {
                    arg3(recipeObj);
                    DShanhaiRecipeEngine.recordRecipe(arg1, true, arg2, 'registro de retorno de chamada concluído');
                    return true;
                } catch (callbackErr) {
            ...
            console.error('[safeAddRecipe] Parâmetro de chamada não suportado');
            return false;
        } catch (err) {
            var recipeId = (typeof arg2 === 'string') ? arg2 : (arg1 && arg1.id ? arg1.id : 'unknown');
            console.error('[safeAddRecipe compat] ' + recipeId + 'Falha no registro:' + err);
            return false;
        }
    };
    ...
    var debug = (typeof debug !== 'undefined') ? debug : function(m) { console.log('[Biblioteca de Receitas]' + m); };
    var broadcastRecipeError = (typeof broadcastRecipeError !== 'undefined') ? broadcastRecipeError : function(type, id, msg) { console.error('[erro de receita]' + type + ': ' + id + ' - ' + msg); };
...
//==========     组装机      ==========
    const assrecipes = [
       ...
       }
       {
        ...
        // ========== 超频仓 ×14 (组装机17号电路) LV~EV: 16个机器外壳 | IV~MAX: 对应并行控制仓 ==========
        { id: 'lv_overclock_hatch',   type: 'assembler', itemInputs: ['16x gtceu:lv_machine_hull',  'kubejs:lv_universal_circuit'],   itemOutputs: ['gt_shanhai:lv_overclock_hatch'],   circuit: 17, EUt: lv,   duration: 200 },
        { id: 'mv_overclock_hatch',   type: 'assembler', itemInputs: ['16x gtceu:mv_machine_hull',  'kubejs:mv_universal_circuit'],   itemOutputs: ['gt_shanhai:mv_overclock_hatch'],   circuit: 17, EUt: mv,   duration: 200 },
        { id: 'hv_overclock_hatch',   type: 'assembler', itemInputs: ['16x gtceu:hv_machine_hull',  'kubejs:hv_universal_circuit'],   itemOutputs: ['gt_shanhai:hv_overclock_hatch'],   circuit: 17, EUt: hv,   duration: 200 },
        { id: 'ev_overclock_hatch',   type: 'assembler', itemInputs: ['16x gtceu:ev_machine_hull',  'kubejs:ev_universal_circuit'],   itemOutputs: ['gt_shanhai:ev_overclock_hatch'],   circuit: 17, EUt: ev,   duration: 200 },
        { id: 'iv_overclock_hatch',   type: 'assembler', itemInputs: ['gtceu:iv_parallel_hatch',   'kubejs:iv_universal_circuit'],   itemOutputs: ['gt_shanhai:iv_overclock_hatch'],   circuit: 17, EUt: iv,   duration: 200 },
        { id: 'luv_overclock_hatch',  type: 'assembler', itemInputs: ['gtceu:luv_parallel_hatch',  'kubejs:luv_universal_circuit'],  itemOutputs: ['gt_shanhai:luv_overclock_hatch'],  circuit: 17, EUt: luv,  duration: 200 },
        { id: 'zpm_overclock_hatch',  type: 'assembler', itemInputs: ['gtceu:zpm_parallel_hatch',  'kubejs:zpm_universal_circuit'],  itemOutputs: ['gt_shanhai:zpm_overclock_hatch'],  circuit: 17, EUt: zpm,  duration: 200 },
        { id: 'uv_overclock_hatch',   type: 'assembler', itemInputs: ['gtceu:uv_parallel_hatch',   'kubejs:uv_universal_circuit'],   itemOutputs: ['gt_shanhai:uv_overclock_hatch'],   circuit: 17, EUt: uv,   duration: 200 },
        { id: 'uhv_overclock_hatch',  type: 'assembler', itemInputs: ['gtceu:uhv_parallel_hatch',  'kubejs:uhv_universal_circuit'],  itemOutputs: ['gt_shanhai:uhv_overclock_hatch'],  circuit: 17, EUt: uhv,  duration: 200 },
        { id: 'uev_overclock_hatch',  type: 'assembler', itemInputs: ['gtceu:uev_parallel_hatch',  'kubejs:uev_universal_circuit'],  itemOutputs: ['gt_shanhai:uev_overclock_hatch'],  circuit: 17, EUt: uev,  duration: 200 },
        { id: 'uiv_overclock_hatch',  type: 'assembler', itemInputs: ['gtceu:uiv_parallel_hatch',  'kubejs:uiv_universal_circuit'],  itemOutputs: ['gt_shanhai:uiv_overclock_hatch'],  circuit: 17, EUt: uiv,  duration: 200 },
        { id: 'uxv_overclock_hatch',  type: 'assembler', itemInputs: ['gtceu:uxv_parallel_hatch',  'kubejs:uxv_universal_circuit'],  itemOutputs: ['gt_shanhai:uxv_overclock_hatch'],  circuit: 17, EUt: uxv,  duration: 200 },
        { id: 'opv_overclock_hatch',  type: 'assembler', itemInputs: ['gtceu:opv_parallel_hatch',  'kubejs:opv_universal_circuit'],  itemOutputs: ['gt_shanhai:opv_overclock_hatch'],  circuit: 17, EUt: opv,  duration: 200 },
        { id: 'max_overclock_hatch',  type: 'assembler', itemInputs: ['gtceu:max_parallel_hatch',  'kubejs:max_universal_circuit'],  itemOutputs: ['gt_shanhai:overclock_hatch'],      circuit: 17, EUt: max,  duration: 200 },
        // ========== 量子计算机 ×5 (IV级 assembler) ==========
        ...
        // ========== 代理执行者 (MV 组装机 18号电路) ==========
        { id: 'proxy_executor', type: 'assembler', itemInputs: ['gtceu:processing_plant', 'gtceu:assemble_plant', 'gtceu:separated_plant', 'gtceu:mixed_plant', '2x gtceu:mv_robot_arm', '2x gtceu:mv_emitter', '2x kubejs:mv_universal_circuit'], inputFluids: ['gtceu:soldering_alloy 288'], itemOutputs: ['gt_shanhai:proxy_executor'], circuit: 18, EUt: mv, duration: 300 }
    ];
...
// 配方验证函数
    ...
    assrecipes.forEach(function(recipe) {
        ...
        if (!validation.valid) {
            console.error('❌ Falha na verificação da receita:' + recipe.id + ' (' + recipe.type + ') - ' + validation.error);
...
//gt_shanhai模组配方批处理
    let myRecipes = [
        ...
        { id: 'coin_forge_cupronickel_coin_source', type: 'coin_forge', notConsumable: ["gtceu:credit_casting_mold"], itemInputs: ["9x dishanhai:copper_coin"], inputFluids: ['gtceu:cupronickel 36000'], itemOutputs: ["16x dishanhai:cupronickel_coin"], EUt: lv, duration: 20 },
        { id: 'primordial_matter_recombination_primordial_coin_forge_source',type:'primordial_matter_recombination',itemInputs:["16x gtceu:credit_casting_mold","64x gtceu:lv_extruder","64x gtceu:lv_forming_press"],itemOutputs:["gt_shanhai:primordial_coin_forge"],EUt:lv,duration:200},
        // ===== LV 机器升级配方 =====
        ...
        // ========== 代理共鸣核心 MK1 (HV, 16x) ==========
        { id: 'primordial_matter_recombination_proxy_resonance_core_mk1', type: 'primordial_matter_recombination', itemInputs: ['64x dishanhai:photon', '32x dishanhai:matter_singularity', '4x dishanhai:wl_board_hv'], inputFluids: ['dishanhai:light 64000', 'dishanhai:matter_fluid_virtual 4000'], itemOutputs: ['dishanhai:proxy_resonance_core_mk1'], EUt: hv, duration: 200 },
        // ===== EV 级 (EUt: 2048) =====
        // ========== 代理共鸣核心 MK1A/B (EV, 32x/48x) ==========
        ...
        // ========== 代理共鸣核心 MK2 (IV, 256x) ==========
        { id: 'primordial_matter_recombination_proxy_resonance_core_mk2', type: 'primordial_matter_recombination', itemInputs: ['128x dishanhai:photon', '64x dishanhai:matter_singularity', '4x dishanhai:wl_board_iv', '4x dishanhai:worldline_residual_fragment'], inputFluids: ['dishanhai:light 128000', 'dishanhai:matter_fluid_darkstar 4000'], itemOutputs: ['dishanhai:proxy_resonance_core_mk2'], EUt: iv, duration: 200 },
        // ===== LuV 级 (EUt: 32768) =====
        ...
        { id: 'primordial_matter_recombination_proxy_resonance_core_mk3', type: 'primordial_matter_recombination', itemInputs: ['256x dishanhai:photon', '128x dishanhai:matter_singularity', '4x dishanhai:wl_board_zpm', '8x dishanhai:worldline_residual_fragment', '2x dishanhai:dimensional_worldline_fragment'], inputFluids: ['dishanhai:light 256000', 'dishanhai:matter_fluid_transition 4000'], itemOutputs: ['dishanhai:proxy_resonance_core_mk3'], EUt: zpm, duration: 200 },
        ...
        { id:'coin_forge_neutronium_coin_source', type: 'coin_forge', notConsumable: ["gtceu:credit_casting_mold"], itemInputs: ["9x dishanhai:naquadah_coin"], inputFluids: ['gtceu:neutronium 36000'], itemOutputs: ["16x dishanhai:neutronium_coin"], EUt: uv, duration: 20 },
        // ========== 代理共鸣核心 MK4 (UV, 4096x) ==========
        { id: 'primordial_matter_recombination_proxy_resonance_core_mk4', type: 'primordial_matter_recombination', itemInputs: ['512x dishanhai:photon', '256x dishanhai:matter_singularity', '4x dishanhai:wl_board_uv', '16x dishanhai:worldline_residual_fragment', '4x dishanhai:dimensional_worldline_fragment', '1x dishanhai:worldline_divergent_core'], inputFluids: ['dishanhai:light 512000', 'dishanhai:matter_fluid_zero 4000'], itemOutputs: ['dishanhai:proxy_resonance_core_mk4'], EUt: uv, duration: 200 },
        // ===== UHV 级 (EUt: uhv) =====
        ...
        // ========== 代理共鸣核心 MK5 (UEV, 16384x) ==========
        { id: 'primordial_matter_recombination_proxy_resonance_core_mk5', type: 'primordial_matter_recombination', itemInputs: ['1024x dishanhai:photon', '512x dishanhai:matter_singularity', '4x dishanhai:wl_board_uev', '32x dishanhai:worldline_residual_fragment', '8x dishanhai:dimensional_worldline_fragment', '2x dishanhai:worldline_divergent_core', '1x dishanhai:worldline_boundless_singularity'], inputFluids: ['dishanhai:light 1024000', 'dishanhai:matter_fluid_ascension 4000'], itemOutputs: ['dishanhai:proxy_resonance_core_mk5'], EUt: uev, duration: 200 },
        // ===== UIV 级 (EUt: uiv) =====
        ...
        { id: 'primordial_matter_recombination_absolute_quantum_purification', type: 'primordial_matter_recombination',
            itemInputs: [ '4x dishanhai:singularity_ring', '1x dishanhai:worldline_genesis_embryo', '32x dishanhai:wl_board_opv',
                          '64x dishanhai:blue_son', '64x dishanhai:genesis_shard', '16x dishanhai:dimensional_worldline_fragment',
                          '8x gtceu:opv_machine_hull', '8x gtceu:opv_field_generator', '16x gtceu:opv_emitter' ],
        ...
        { id: 'coin_forge_primordialmatter_coin_source', type: 'coin_forge',notConsumable: ["gtceu:credit_casting_mold"], itemInputs: ["9x dishanhai:transcendentmetal_coin"], inputFluids: ['gtceu:primordialmatter 36000'], itemOutputs: ["16x dishanhai:primordialmatter_coin"], EUt: max, duration: 20 },
        { id: 'coin_forge_chaos_coin_source', type: 'coin_forge',notConsumable: ["gtceu:credit_casting_mold"], itemInputs: ["9x dishanhai:primordialmatter_coin"], inputFluids: ['gtceu:chaos 36000'], itemOutputs: ['16x dishanhai:chaos_coin'], EUt: max, duration: 20 },
        { id: 'coin_forge_cosmic_coin_source', type: 'coin_forge',notConsumable: ["gtceu:credit_casting_mold"], itemInputs: ["9x dishanhai:chaos_coin"], inputFluids: ['gtceu:cosmic 36000'], itemOutputs: ["16x dishanhai:cosmic_coin"], EUt: max, duration: 20 },
        { id: 'coin_forge_magmatter_coin_source', type: 'coin_forge',notConsumable: ["gtceu:credit_casting_mold"], itemInputs: ["9x dishanhai:chaos_coin"], inputFluids: ['gtceu:magmatter 36000'], itemOutputs: ["16x dishanhai:magmatter_coin"], EUt: max, duration: 20 },
        { id: 'coin_forge_eternity_coin_source', type: 'coin_forge',notConsumable: ["gtceu:credit_casting_mold","kubejs:eternity_catalyst"], itemInputs: ["9x dishanhai:magmatter_coin"], inputFluids: ['gtceu:eternity 36000'], itemOutputs: ["16x dishanhai:eternity_coin"], EUt: max, duration: 20 },
        { id: 'coin_forge_magnetohydrodynamicallyconstrainedstarmatter_coin_coin', type: 'coin_forge',notConsumable: ["gtceu:credit_casting_mold"], itemInputs: ["9x dishanhai:cosmic_coin"], inputFluids: ['gtceu:magnetohydrodynamicallyconstrainedstarmatter 36000'], itemOutputs: ["16x dishanhai:magnetohydrodynamicallyconstrainedstarmatter_coin"], EUt: max, duration: 20 },
        { id: 'coin_forge_star_gate_crystal_slurry_coin_coin', type: 'coin_forge',notConsumable: ["gtceu:credit_casting_mold"], itemInputs: ["9x dishanhai:magmatter_coin","9x dishanhai:eternity_coin","9x dishanhai:chaos_coin","9x dishanhai:infinite_coin","9x dishanhai:cosmic_coin","9x dishanhai:magnetohydrodynamicallyconstrainedstarmatter_coin","9x dishanhai:transcendentmetal_coin","9x dishanhai:primordialmatter_coin"], inputFluids: ['gtladditions:star_gate_crystal_slurry 3600'], itemOutputs: ["dishanhai:star_gate_crystal_slurry_coin"], EUt: max*114514, duration: 20 },
        // ========== 代理共鸣核心 MK6 (MAX, 65536x) ==========
        { id: 'primordial_matter_recombination_proxy_resonance_core_mk6', type: 'primordial_matter_recombination', itemInputs: ['2048x dishanhai:photon', '1024x dishanhai:matter_singularity', '4x dishanhai:wl_board_max', '64x dishanhai:worldline_residual_fragment', '16x dishanhai:dimensional_worldline_fragment', '4x dishanhai:worldline_divergent_core', '2x dishanhai:worldline_boundless_singularity', '1x dishanhai:worldline_imaginary_string'], inputFluids: ['dishanhai:light 2048000', 'dishanhai:matter_fluid_eternal 4000'], itemOutputs: ['dishanhai:proxy_resonance_core_mk6'], EUt: max, duration: 200 },
        { id: 'primordial_matter_recombination_proxy_resonance_core_mk6a', type: 'primordial_matter_recombination', itemInputs: ['4096x dishanhai:photon', '2048x dishanhai:matter_singularity', '8x dishanhai:wl_board_max', '128x dishanhai:worldline_residual_fragment', '32x dishanhai:dimensional_worldline_fragment', '8x dishanhai:worldline_divergent_core', '4x dishanhai:worldline_boundless_singularity', '2x dishanhai:worldline_imaginary_string'], inputFluids: ['dishanhai:light 4096000', 'dishanhai:matter_fluid_eternal 8000'], itemOutputs: ['dishanhai:proxy_resonance_core_mk6a'], EUt: max, duration: 200 },
        { id: 'primordial_matter_recombination_proxy_resonance_core_mk6b', type: 'primordial_matter_recombination', itemInputs: ['6144x dishanhai:photon', '3072x dishanhai:matter_singularity', '12x dishanhai:wl_board_max', '192x dishanhai:worldline_residual_fragment', '48x dishanhai:dimensional_worldline_fragment', '12x dishanhai:worldline_divergent_core', '6x dishanhai:worldline_boundless_singularity', '3x dishanhai:worldline_imaginary_string'], inputFluids: ['dishanhai:light 6144000', 'dishanhai:matter_fluid_eternal 12000'], itemOutputs: ['dishanhai:proxy_resonance_core_mk6b'], EUt: max, duration: 200 },
        // ===== 苦命鸳鸯 =====
...
//宏产世界碎片
    ...
    try {
        ...
        if (outputStacks.length === 0) {
            console.log('Nenhuma saída válida de produto de minério, pule star_core_stripper_ores');
        } else {
            safeAddRecipe('star_core_stripper', 'dishanhai:star_core_stripper_ores', function() {
                gtr.star_core_stripper('dishanhai:star_core_stripper_ores')
                    ...
                    .EUt(max)
                    .duration(200);
                console.log('saída' + outputStacks.length + 'Produto de minério (prefixo de impureza excluído)');
            },{defaultEnabled:false});
        }
    } catch(err) {
        console.log(err);
...
// 以下配方需要 gt_shanhai 模组注册的配方类型
    ...
    const assemblerRecipes = [
        { id: 'heidonqidian', type:'qft', name: 'Montagem de singularidade de buraco negro',circuit:1,notConsumable:'16x gtladditions:forge_of_the_antichrist', itemInputs: ['kubejs:naquadria_charge','64x kubejs:time_dilation_containment_unit','64x kubejs:charged_triplet_neutronium_sphere'], itemOutputs: ['1920x kubejs:contained_reissner_nordstrom_singularity'], EUt:uxv, duration: 20 },
        { id: 'qiyiqid', type:'qft', name: 'Montagem de matéria estranha', circuit:2,notConsumable:'16x gtladditions:forge_of_the_antichrist',itemInputs: ['15x gtceu:degenerate_rhenium_dust','kubejs:leptonic_charge','kubejs:contained_high_density_protonic_matter'], itemOutputs: ['30x kubejs:contained_exotic_matter'], EUt: UXV, duration: 20 },
        { id: 'gaomiduqidian', type:'qft', name: 'Montagem de material de alta densidade',circuit:3,notConsumable:'16x gtladditions:forge_of_the_antichrist', itemInputs: ['kubejs:leptonic_charge','kubejs:time_dilation_containment_unit','kubejs:charged_triplet_neutronium_sphere'], itemOutputs: ['30x kubejs:contained_high_density_protonic_matter'], EUt: UXV, duration: 20 },
        { id: 'niumanheidonqidian', type:'qft', name: 'Assembleia de Singularidade de Kerr Newman',circuit:4,notConsumable:'16x gtladditions:forge_of_the_antichrist' ,itemInputs: ['kubejs:time_dilation_containment_unit','64x kubejs:charged_triplet_neutronium_sphere'], inputFluids: ['gtceu:uu_matter 10000'], itemOutputs: ['30x kubejs:contained_kerr_newmann_singularity'], EUt: UXV, duration: 20 }
...
// ========== 分子解构配方组 ==========
    ...
    const molecularRecipes = [
        { id: 'ytyh', type: 'molecular_deconstruction', name: 'Desconstrução do tempo e do espaço em pó', itemInputs: ['gtceu:spacetime_dust'], outputFluids: ['gtceu:spacetime 144'], EUt: opv, duration: 20 },
        { id: 'ciyues', type: 'molecular_deconstruction', name: 'Desconstrução de fluido magnético estelar', itemInputs: ['gtceu:magnetohydrodynamicallyconstrainedstarmatter_block'], outputFluids: ['gtceu:magnetohydrodynamicallyconstrainedstarmatter 1296'], EUt:max, duration: 20 },
        { id: 'ytciwuz', type: 'molecular_deconstruction', name: 'Desconstrução da matéria magnética', itemInputs: ['gtceu:magmatter_dust'], outputFluids: ['gtceu:magmatter 144'], EUt: 2147483647, duration: 20 },
        {id:'magnetohydrodynamicallyconstrainedstarmatter_dust', type: 'molecular_deconstruction', name:'Desconstrução da matéria estelar restringida pelo fluido magnético',itemInputs:['gtceu:magnetohydrodynamicallyconstrainedstarmatter_dust'],outputFluids:['gtceu:magnetohydrodynamicallyconstrainedstarmatter 144'],EUt:max, duration: 20}
    ];
    ...
    const compressorRecipes = [
        { id: 'tiny_magmatter_dust', name: 'Compressão de pó de material magnético 1', itemInputs: ['9x gtceu:tiny_magmatter_dust'], itemOutputs: ['gtceu:small_magmatter_dust'], EUt: 2147483, duration: 20 },
        { id: 'magmatter_dust', name: 'Compressão de pó de material magnético 2', itemInputs: ['9x gtceu:small_magmatter_dust'], itemOutputs: ['gtceu:magmatter_dust'], EUt: 21474836, duration: 20 }
    ];
    ...
    if(Platform.isLoaded('appflux')){
        ...
        debug('O módulo appflux não é carregado e as receitas relacionadas são ignoradas.');
    }
...
//==============  通用配方 =================(wx,wuxian,♾️,wx)
    var dishanhai_timer = DShanhaiRecipeEngine.startTimer('♾️Receitas de itens de Shan Hai');
    ...
    safeAddRecipe('cosmos_simulation', 'dishanhai:creator_God_home', () => {
        gtr.cosmos_simulation("dishanhai:creator_God_home")
            ...
            .itemOutputs(
                ...
                Item.of('ae2:portable_item_cell_16k', "{ RepairCost:0,amts:[L;1L,1L,1L,1L,1L,1L,1L,1L,1L,1L,1L,1L,1L,1L,1L],exibição:{Nome:'{\"texto\":\"Pacote de componentes de placa de circuito universal\"}'}, ic:15L, internalCurrentPower:20000.0d,chaves:[{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:i \",id:\" kubejs:ulv_universal_circuit \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:i \",id:\" kubejs:lv_universal_circuit \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:i \",id:\" kubejs:mv_universal_circuit \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \" \",tag:{registro:{\"#c\":\" ae2:i \",id:\" kubejs:hv_universal_circuit \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:i \",id:\" kubejs:ev_universal_circuit \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:i \",id:\" kubejs:iv_universal_circuit \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:i \",id:\" kubejs:luv_universal_circuit \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:i \",id:\" kubejs:zpm_universal_circuit \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \" \",tag:{registro:{\"#c\":\" ae2:i \",id:\" kubejs:uv_universal_circuit \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:i \",id:\" kubejs:uhv_universal_circuit \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:i \",id:\" kubejs:uev_universal_circuit \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:i \",id:\" kubejs:uiv_universal_circuit \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:i \",id:\" kubejs:uxv_universal_circuit \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \" \",tag:{registro:{\"#c\":\" ae2:i \",id:\" kubejs:opv_universal_circuit \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:i \",id:\" kubejs:max_universal_circuit \"}}}]}"),
                ...
                Item.of('ae2:portable_item_cell_16k', "{ RepairCost:0,amts:[L;64L,64L,64L,64L,64L,64L,64L,128L,64L,64L,64L,64L,64L,64L,64L],exibição:{Nome:'{\"text\":\"Pacote de componentes do módulo\"}'}, ic:1024L, internalCurrentPower:20000.0d,chaves:[{\"#c\":\" ae2:i \",id:\" thetornproductionline:hyper_excitation_module_3 \"},{\"#c\":\" ae2:i \",id:\" thetornproductionline:fishbig_process_module_p3 \"},{\"#c\":\" ae2:i \",id:\" thetornproductionline:fishbig_process_module_p6 \"},{\"#c\":\" ae2:i \",id:\" thetornproductionline:fishbig_process_module_p1 \"},{\"#c\":\" ae2:i \",id:\" thetornproductionline:fishbig_process_module_p8 \"},{\"#c\":\" ae2:i \",id:\" thetornproductionline:fishbig_process_module \"},{\"#c\":\" ae2:i \",id:\" thetornproductionline:fishbig_process_module_p4 \"},{\"#c\":\" ae2:i \",id:\" thetornproductionline:fishbig_process_module_base \"},{\"#c\":\" ae2:i \",id:\" thetornproductionline:fishbig_process_module_p2 \"},{\"#c\":\" ae2:i \",id:\" thetornproductionline:fission_reactor_module \"},{\"#c\":\" ae2:i \",id:\" thetornproductionline:neutron_activator_module \" \"},{\"#c\":\" ae2:i \",id:\" thetornproductionline:fusion_process_module \"},{\"#c\":\" ae2:i \",id:\" thetornproductionline:circult_process_module_4 \"},{\"#c\":\" ae2:i \",id:\" thetornproductionline:fishbig_process_module_p7 \"},{\"#c\":\" ae2:i \",id:\" thetornproductionline:black_hole_engine_module \"}]}"),
                Item.of('ae2:portable_item_cell_16k', "{ RepairCost:0,amts:[L;1L,1L,1L,1L,1L,1L,1L,1L,1L,1L,1L,1L,1L,1L,1L,1L,1L,1L,1L,1L,1L,1L,1L],display:{Nome:'{\"texto\":\"Pacote de componentes petrificados de madeira\"}'}, ic:23L, internalCurrentPower:20000.0d,chaves:[{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:ethanol \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:naphthalene \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:octane \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:ethane \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:propane \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:butane \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \" \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:toluene \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:benzene \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:butadiene \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:butene \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:propene \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \" \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:ethylene \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:methanol \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:absolute_ethanol \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:methane \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:methyl_acetate \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \" \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:acetic_acid \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:carbon \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:creosote \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:carbon_monoxide \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:dimethylbenzene \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \" \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:acetone \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:phenol \"}}}]}"),
                Item.of('ae2:portable_item_cell_16k', "{ RepairCost:0,amts:[L;1L,1L,1L],exibição:{Nome:'{\"text\":\"Pacote de componentes de detecção cósmica\"}'}, ic:3L, internalCurrentPower:20000.0d,chaves:[{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:cosmic_element \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:starlight \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:heavy_lepton_mixture \"}}}]}"),
                ...
                Item.of('ae2:portable_item_cell_16k', "{ RepairCost:0,amts:[L;1L,1L,1L,1L,1L,1L],exibição:{Nome:'{\"text\":\"Pacote de componente de coleta de gás\"}'}, ic:6L, internalCurrentPower:20000.0d,chaves:[{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:air \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:liquid_air \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:nether_air \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:liquid_nether_air \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:ender_air \"}}},{\"#c\":\" ae2:i \",id:\" expatternprovider:infinity_cell \" \",tag:{registro:{\"#c\":\" ae2:f \",id:\" gtceu:liquid_ender_air \"}}}]}"),
                Item.of('ae2:portable_item_cell_16k', "{ RepairCost:0,valores:[L;5L,10L,5L,128L,64L,64L,1L,1L,1L,5L,64L,64L,5L,5L,5L,1L,1 28L,1L,1145L,1L,64L,1L,1L,1L,64L,1024L,1L,128L,5L,1L,64L,10L,128L,1L,14L,64L,128L,64L,1L,64L,128L,128L,1L,9L,512L,64L,64L,1L,256L, 64L,10L,5L,5L,256L,128L,64L],exibir:{Nome:'{\"texto\":\"Criar componente de item Pacote\"}'}, ic:5226L, internalCurrentPower:20000.0d,chaves:[{\"#c\":\" ae2:i \",id:\" avaritia:endless_cake \"},{\"#c\":\" ae2:i \",id:\" mekanism:creative_chemical_tank \"},{\"#c\":\" ae2:i \",id:\" sgjourney:universe_stargate \"},{\"#c\":\" ae2:i \",id:\" gtceu:creative_energy \"},{\"#c\":\" ae2:i \",id:\" gtceu:research_station \"},{\"#c\":\" ae2:i \",id:\" gtceu:ancient_gold_coin \"},{\"#c\":\" ae2:i \",id:\" sgjourney:pegasus_dhd \",tag:{BlockEntityTag:{ Energy:0L,Inventário:{Itens:[{ Count:1b, Slot:0,id:\" sgjourney:large_control_crystal \"},{ Count:1b, Slot:1,id:\" sgjourney:advanced_energy_crystal \",tag: {Energy:0} },{ Count:1b, Slot:2,id:\" sgjourney:advanced_communication_crystal \",tag: {Frequency:0} },{ Count:1b, Slot:3,id:\" sgjourney:advanced_energy_crystal \",tag: {Energy:0} },{ Count:1b, Slot:6,id:\" sgjourney:advanced_communication_crystal \",tag: {Frequency:0} },{ Count:1b, Slot:7,id:\" sgjourney:advanced_transfer_crystal \",tag: {TransferLimit:5000L} }], Size:9 },energy_inventory:{Itens:[{ Count:1b, Slot:0,id:\" sgjourney:fusion_core \"}], Size:2 },id:\" sgjourney:pegasus_dhd \"}}},{\"#c\":\" ae2:i \",id:\" avaritia:infinity_sword \"},{\"#c\":\" ae2:i \",id:\" avaritia:infinity_axe \"},{\"#c\":\" ae2:i \",id:\" avaritia:infinity_umbrella \"},{\"#c\":\" ae2:i \",id:\" gtlcore:super_glue \"},{\"#c\":\" ae2:i \",id:\" gtceu:creative_data_access_hatch \"},{\"#c\":\" ae2:i \",id:\" appmek:creative_chemical_cell \"},{\"#c\":\" ae2:i \",id:\" mekanism:creative_bin \"},{\"#c\":\" ae2:i \",id:\" ae2:creative_item_cell \"},{\"#c\":\" ae2:i \",id:\" avaritia:infinity_totem \",tag: {Damage:0} },{\"#c\":\" ae2:i \",id:\" gtmthings:creative_laser_hatch \"},{\"#c\":\" ae2:i \",id:\" ae2:fluix_axe \",tag: {Damage:0} },{\"#c\":\" ae2:i \",id:\" kubejs:giga_chad \"},{\"#c\":\" ae2:i \",id:\" avaritia:infinity_pickaxe \",tag:{}},{\"#c\":\" ae2:i \",id:\" kubejs:create_ultimate_battery \"},{\"#c\":\" ae2:i \",id:\" avaritia:infinity_bucket \"},{\"#c\":\" ae2:i \",id:\" avaritia:infinity_helmet \"},{\"#c\":\" ae2:i \",id:\" avaritia:infinity_pants \"},{\"#c\":\" ae2:i \",id:\" gtceu:neutronium_credit \"},{\"#c\":\" ae2:i \",id:\" avaritia:ultimate_stew \"},{\"#c\":\" ae2:i \",id:\" projecte:tome \"},{\"#c\":\" ae2:i \",id:\" gtceu:creative_chest \"},{\"#c\":\" ae2:i \",id:\" ae2:creative_fluid_cell \"},{\"#c\":\" ae2:i \",id:\" sgjourney:pegasus_stargate \"},{\"#c\":\" ae2:i \",id:\" gtceu:door_of_create \"},{\"#c\":\" ae2:i \",id:\" mekanism:creative_fluid_tank \"},{\"#c\":\" ae2:i \",id:\" gtmthings:creative_item_input_bus \"},{\"#c\":\" ae2:i \",id:\" avaritia:infinity_chestplate \"},{\"#c\":\" ae2:i \",id:\" sgjourney:classic_stargate_ring_block \"},{\"#c\":\" ae2:i \",id:\" gtceu:doge_coin \"},{\"#c\":\" ae2:i \",id:\" gtmthings:creative_energy_hatch \"},{\"#c\":\" ae2:i \",id:\" gtladditions:arcanic_astrograph \"},{\"#c\":\" ae2:i \",id:\" sgjourney:classic_stargate_base_block \"},{\"#c\":\" ae2:i \",id:\" gtladditions:heart_of_the_universe \"},{\"#c\":\" ae2:i \",id:\" gtmthings:creative_fluid_input_hatch \"},{\"#c\":\" ae2:i \",id:\" gtceu:creative_tank \"},{\"#c\":\" ae2:i \",id:\" avaritia:infinity_boots \"},{\"#c\":\" ae2:i \",id:\" sgjourney:classic_stargate_chevron_block \"},{\"#c\":\" ae2:i \",id:\" kubejs:heartofthesmogus \"},{\"#c\":\" ae2:i \",id:\" minecraft:command_block \"},{\"#c\":\" ae2:i \",id:\" gtceu:eye_of_harmony \"},{\"#c\":\" ae2:i \",id:\" gtceu:lava_furnace \"},{\"#c\":\" ae2:i \",id:\" expatternprovider:fishbig \"},{\"#c\":\" ae2:i \",id:\" gtceu:chocolate_coin \"},{\"#c\":\" ae2:i \",id:\" mekanism:creative_energy_cube \",tag:{mekData:{Containers de energia:[{ Container:0b,armazenado:\"18446744073709551615.9999\"}],componentConfig:{config0:{ side0:4, side1:4, side2:4, side3:4, side4:4, side5:4 }}}}},{\"#c\":\" ae2:i \",caps:{Pai:{Itens:[], Size:81 }},id:\" avaritia:neutron_ring \"},{\"#c\":\" ae2:i \",id:\" avaritia:infinity_ring \"},{\"#c\":\" ae2:i \",id:\" gtlcore:ultimate_tea \"},{\"#c\":\" ae2:i \",id:\" gtceu:creative_computation_provider \"},{\"#c\":\" ae2:i \",id:\" gtceu:create_aggregation \"}],sort_by:\"MOD\",sort_direction:\"ASCENDENTE\",view_mode:\"ALL\"}"),
...
// 创造模块 - 修复版
    ...
    var timercre = DShanhaiRecipeEngine.startTimer('Módulo Fundador de Modificação da Realidade')
...
// 混沌炼金
    ...
    var timer_electrolyzer = DShanhaiRecipeEngine.startTimer('Eletrolisador')
...
// ========== ae2_overclocked 模组配方 ==========
    ...
    e.shapeless(
        "gt_shanhai:guide_book",
        ["minecraft:paper","dishanhai:copper_coin"]
    );

    // ========== 输出物品盘配方 ==========
    info('📀Comece a gerar receita de pacote super AE...');
    ...
    try {
        ...
        info('✅ A receita do pacote Super AE foi gerada id= dishanhai:super_ae_pack NBT_len=' + (superAENBT ? superAENBT.length : 'null'));
    } catch(err) {
        error('❌ Falha na geração da receita do pacote Super AE:' + err.message);
    }
    ...
    try {
        info('🎨 Comece a gerar receitas profissionais ilimitadas de pacotes de componentes de corantes...');

        var dyeItemsList = Ingredient.of('#forge:dyes').getItemIds();
        if (!dyeItemsList || dyeItemsList.length === 0) {
            throw new Error('Item de corante não encontrado, tag # forge:dyes pode estar vazia');
        }
        var dyeSeen = {};
        var dyeUniqueList = [];
        for (var dyeIndex = 0; dyeIndex < dyeItemsList.length; dyeIndex++) {
            var dyeId = String(dyeItemsList[dyeIndex]);
            if (dyeSeen[dyeId]) continue;
            dyeSeen[dyeId] = true;
            dyeUniqueList.push(dyeId);
        }
        dyeItemsList = dyeUniqueList;
        info('🎨 Obtido da tag # forge:dyes' + dyeItemsList.length + 'itens de tingimento');
        gtr.assembler(dyeRecipeId)
            .circuit(1)
            .itemInputs('minecraft:dandelion')
            .itemOutputs(DShanhaiSDA.create('pacote de componente de corante ilimitado pro').infinityOutputs(dyeItemsList).lore([
                '§7Pacote de componentes ilimitado contendo todos os itens de tintura',
                'Tipo de corante §7: §e' + dyeItemsList.length + 'Espécies §7',
                '§7Cada corante é armazenado em um pacote de elementos ilimitado',
                '§8Bens privados Shanhai v2.2'
            ]).build())
            .duration(200)
            .EUt(LV);

        try { DShanhaiRecipeEngine.recordRecipe(dyeRecipeType, true, dyeRecipeId, ''); } catch(ignored) {}
        info('✅ A receita pro do pacote de componentes de corante infinito foi gerada');
    } catch(err) {
        error('❌ Falha na geração de receita pro pacote de componentes de corante ilimitado:' + err.message);
        try { DShanhaiRecipeEngine.recordRecipe(dyeRecipeType, false, dyeRecipeId, err.message); } catch(ignored) {}
    }

    // ========== 天基大礼包配方 ==========
    info('🔧 Comece a gerar receitas de pacotes de presentes baseadas no espaço...');
    ...
    try {
        gtr.assembler(piggrecipeId)
            ...
            .itemOutputs(Item.of('gt_shanhai:super_disk_array', getShanhaiPackNBT('skyBase')))
            .duration(200)
            .EUt(LV);

        info('✅ A receita do pacote de presente Tianji foi gerada');
    } catch(err) {
        error('❌ Falha na geração da receita do pacote de presente Tianji:' + err.message);
    }

    // ========== 猪咪大礼包配方 ==========
    info('🔧 Comece a gerar pacotes de presentes porquinhos...');
    ...
    try {
        ...
        gtr.assembler(templaterecipeId)
            ...
            .duration(200)
            .EUt(LV);
        info('✅ A receita do pacote de presente Piggy foi gerada:' + templaterecipeId);
    } catch(err) {
        error('❌ Falha ao gerar a receita do pacote de presente do porquinho:' + err.message);
    }

    // ========== 奇点数据中枢建材存储阵列配方 ==========
    info('🔧 Matriz de armazenamento de materiais de construção de data center Singularity...');
    try {
        ...
        error('❌ Falha na geração da receita:' + err.message);
    }
    ...
    try {
        ...
        info('🎨Entenda' + dyeItemsList.length + 'tipo de itens');
        gtr.assembler('dishanhai:super_disk_array_naquadah_pack')
            .circuit(1)
            .itemInputs("dishanhai:dishanhai")
            .itemOutputs(DShanhaiSDA.create('Circuito integrado DASDA')
                .infinityOutputs(dyeItemsList)
                .lore([
                    "Construção interna de itens/fluidos relacionados a circuitos integrados",
                    '§7Elementos de armazenamento ilimitados automaticamente incorporados',
                    '§7Número de entradas: §e' + dyeItemsList.length,
                    '{ultimate} O Deus das Montanhas e dos Mares, Bens Privados v2.7.3{/}'
                ])
                .build())
            .duration(200)
            .EUt(LV);
        try { DShanhaiRecipeEngine.recordRecipe(dyeRecipeType_2, true, dyeRecipeId_2, ''); } catch(ignored) {}
    } catch(err) {
        error('❌ Falha na geração ilimitada de receita do pacote de componentes:' + err.message);
    ...
    const gtceuFluidRecipeId = 'dishanhai:infinity_gtceu_fluid_pack';

    try {
        info('🎨 Comece a gerar receitas ilimitadas de pacotes de componentes fluidos gtceu...');
        ...
        ForgeRegistries.FLUIDS.getKeys().forEach(function(key) {
            var id = key.toString();
            if (/^gtceu:.+/.test(id)) {
                gtceuFluidList.push(id);
            }
        });
        if (!gtceuFluidList || gtceuFluidList.length === 0) {
            throw new Error('Nenhum fluido encontrado para o módulo gtceu');
        }
        info('🎨 encontrado' + gtceuFluidList.length + 'espécie gtceu fluido');

        var _gtceuFluidItems = [];
        for (var _fi = 0; _fi < gtceuFluidList.length; _fi++) {
            _gtceuFluidItems.push('1x expatternprovider:infinity_cell@' + gtceuFluidList[_fi]);
        }
        gtr.assembler(gtceuFluidRecipeId)
            .circuit(1)
            .itemInputs('minecraft:dandelion')
            .itemOutputs(DShanhaiSDA.create('matriz de super disco')
                .infinityOutputs(gtceuFluidList)
                .lore([
                    '§7Pacote de componentes ilimitado contendo todos os fluidos gtceu',
                    'Tipo de fluido §7: §e' + gtceuFluidList.length + 'Espécies §7',
                    '§7Cada fluido é armazenado em pacotes de elementos ilimitados',
                    '§8Bens privados Shanhai v2.7'
                ])
                .build())
            .duration(200)
            .EUt(LV);

        try { DShanhaiRecipeEngine.recordRecipe(gtceuFluidRecipeType, true, gtceuFluidRecipeId, ''); } catch(ignored) {}
        info('✅ Foi gerada uma receita ilimitada de pacote de componentes fluidos gtceu');
    } catch(err) {
        error('❌ Falha na geração ilimitada de receita do pacote de componentes de fluido gtceu:' + err.message);
        try { DShanhaiRecipeEngine.recordRecipe(gtceuFluidRecipeType, false, gtceuFluidRecipeId, err.message); } catch(ignored) {}
    }
    */

    //&& ========== 无限plasma流体元件包配方（可选）==========
    /*
    const plasmaFluidRecipeType = 'assembler';
    const plasmaFluidRecipeId = 'dishanhai:infinity_plasma_fluid_pack';

    try {
        info('🎨 Comece a gerar receitas ilimitadas de pacotes de componentes de fluido de plasma...');

        var plasmaFluidList = [];
        ForgeRegistries.FLUIDS.getKeys().forEach(function(key) {
            var id = key.toString();
            if (/plasma$/.test(id)) {
                plasmaFluidList.push(id);
            }
        });
        if (!plasmaFluidList || plasmaFluidList.length === 0) {
            throw new Error('fluido plasmático não encontrado');
        }
        info('🎨 encontrado' + plasmaFluidList.length + 'fluido plasmático');

        var _plasmaFluidItems = [];
        for (var _pi = 0; _pi < plasmaFluidList.length; _pi++) {
            _plasmaFluidItems.push('1x expatternprovider:infinity_cell@' + plasmaFluidList[_pi]);
        }
        gtr.assembler(plasmaFluidRecipeId)
            .circuit(1)
            .itemInputs('minecraft:dandelion')
            .itemOutputs(DShanhaiSDA.create('Pacote ilimitado de componentes de óleo')
                .infinityOutputs(plasmaFluidList)
                .lore([
                    '§7Pacote de componentes ilimitado contendo todos os óleos',
                    '§7Tipo de item: §e' + plasmaFluidList.length + 'Espécies §7',
                    '§7Cada item é armazenado em um pacote infinito de componentes',
                    '§8Bens privados Shanhai v2.7'
                ])
                .build())
            .duration(200)
        ...
        try { DShanhaiRecipeEngine.recordRecipe(plasmaFluidRecipeType, true, plasmaFluidRecipeId, ''); } catch(ignored) {}
        info('✅ Foi gerada uma receita ilimitada de pacote de componentes de fluido de plasma');
    } catch(err) {
        error('❌ Falha na geração ilimitada de receita do pacote de componentes de fluido de plasma:' + err.message);
        try { DShanhaiRecipeEngine.recordRecipe(plasmaFluidRecipeType, false, plasmaFluidRecipeId, err.message); } catch(ignored) {}
    }
    */

    // ========== 光子矩阵蚀刻配方 ==========
    var photon_matrix_start = Date.now();
    info('🔬 Comece a se registrar para a receita de gravação de matriz de fótons...');
    ...
    waferTypes.forEach((wafer, index) => {
        ...
        batches.forEach(batch => {
            ...
            photonRecipes.push({
                id: `${wafer.id}_wafer_${batch.suffix}`,
                type: 'photon_matrix_etch',
    ...
    photonRecipes.forEach(function(recipe) {
        var ok = safeAddRecipe('photon_matrix_etch', 'dishanhai:' + recipe.id, function() {
            gtr.photon_matrix_etch('dishanhai:' + recipe.id)
                .circuit(recipe.circuit)
        ...
        if (ok) photonRecipeCount++;
    });

    var photon_time = (Date.now() - photon_matrix_start).toFixed(2);
    info(`✔️ 光子矩阵蚀刻配方注册完成 成功: ${photonRecipeCount} 个 | 耗时：${photon_time}ms`);

    // ========== 维度聚焦激光蚀刻配方 ==========
    var focus_engraving_start = Date.now();
    info('🔬 Comece a se registrar na Fórmula de Gravura a Laser Dimension Focus...');
    ...
    var focus_uev = focus_GTValues[10], focus_uiv = focus_GTValues[11], focus_uxv = focus_GTValues[12], focus_opv = focus_GTValues[13], focus_max = focus_GTValues[14];
    ...
    waferTypes_2.forEach((wafer, index) => {
        ...
        batches_2.forEach(batch => {
            ...
            focusRecipes.push({
                id: `${wafer.id}_wafer_${batch.suffix}_focus`,
                type: 'dimensional_focus_engraving_array',
                itemInputs: [batch.input],
    ...
    focusRecipes.forEach(function(recipe) {
        var ok = safeAddRecipe('dimensional_focus_engraving_array', 'dishanhai:' + recipe.id, function() {
            gtr.dimensional_focus_engraving_array('dishanhai:' + recipe.id)
                .circuit(recipe.circuit)
                .itemInputs(recipe.itemInputs)
                .itemOutputs(recipe.itemOutputs)
                .EUt(recipe.EUt)
        ...
        if (ok) focusRecipeCount++;
    });

    var focus_time = (Date.now() - focus_engraving_start).toFixed(2);
    info(`✔️ 维度聚焦激光蚀刻配方注册完成 成功: ${focusRecipeCount} 个 | 耗时：${focus_time}ms`);

    // ========== 星焰跃迁等离子体配方 ==========
    var stellar_start = Date.now();
    info('⭐ Comece a registrar a receita de plasma Star Flame Jump...');
    ...
    var stellarRecipes = [
        {id:'echoite_plasma', inputFluid: 'gtceu:echoite', outputFluid: 'gtceu:echoite_plasma', count: 10000, voltage: stellar_uev},
        {id:'chaos_plasma', inputFluid: 'gtceu:chaos', outputFluid: 'gtceu:chaos_plasma', count: 10000, voltage: stellar_uev},
        {id:'adamantium_plasma', inputFluid: 'gtceu:adamantium', outputFluid: 'gtceu:adamantium_plasma', count: 10000, voltage: stellar_uev},
        {id:'legendarium_plasma', inputFluid: 'gtceu:legendarium', outputFluid: 'gtceu:legendarium_plasma', count: 10000, voltage: stellar_uev},
        {id:'celestial_secret_plasma', inputFluid: 'gtceu:celestial_secret', outputFluid: 'gtceu:celestial_secret_plasma', count: 10000, voltage: stellar_uev},
        {id:'cosmic_mesh_plasma', inputFluid: 'gtceu:liquid_cosmic_mesh', outputFluid: 'gtceu:cosmic_mesh_plasma', count: 10000, voltage: stellar_uev},
        {id:'instability_plasma', inputFluid: 'gtceu:instability', outputFluid: 'gtceu:instability_plasma', count: 10000, voltage: stellar_uev},
        {id:'tear_plasma', inputFluid: 'gtceu:tear', outputFluid: 'gtceu:tear_plasma', count: 10000, voltage: stellar_uev},
        {id:'astraltitanium_plasma', inputFluid: 'gtceu:astraltitanium', outputFluid: 'gtceu:astraltitanium_plasma', count: 10000, voltage: stellar_uev},
        {id:'degenerate_rhenium_plasma', inputFluid: 'gtceu:degenerate_rhenium_plasma', outputFluid: 'gtceu:liquid_degenerate_rhenium', count: 10000, voltage: stellar_uev},
        {id:'creon_plasma', inputFluid: 'gtladditions:creon', outputFluid: 'gtladditions:creon_plasma', count: 10000, voltage: stellar_uev},
        {id:'crystalmatrix_plasma', inputFluid: 'gtceu:crystalmatrix', outputFluid: 'gtceu:crystalmatrix_plasma', count: 10000, voltage: stellar_uev}
    ];

    var stellarRecipeCount = 0;
    stellarRecipes.forEach(function(recipe) {
        var ok = safeAddRecipe('stellar_lgnition', 'dishanhai:' + recipe.id, function() {
            gtr.stellar_lgnition('dishanhai:' + recipe.id)
                .inputFluids(`${recipe.inputFluid} ${recipe.count}`)
                .outputFluids(`${recipe.outputFluid} ${recipe.count}`)
                .blastFurnaceTemp(10000)
                .EUt(recipe.voltage)
                .duration(20);
        });
        if (ok) stellarRecipeCount++;
    });

    var stellar_time = (Date.now() - stellar_start).toFixed(2);
    info(`✔️ 星焰跃迁等离子体配方注册完成 成功: ${stellarRecipeCount} 个 | 耗时：${stellar_time}ms`);
