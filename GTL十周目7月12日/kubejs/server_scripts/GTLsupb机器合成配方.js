(function() {
    ...
    try {
        ...
        if (config === null || typeof config !== 'object') {
            console.warn('[GTLsupb] O arquivo de configuração é inválido ou ausente, use a configuração padrão');
            throw new Error();
        }
    } catch(e) {
        config = {};
    ...
    if (!GTLsupb.enableAll) {
        if (!enableBlastScript) log('Como a chave mestre global está desligada, o registro da receita é ignorado.');
        else log('O registro da receita é ignorado porque a chave do módulo está desligada.');
        return;
    }
    ...
    ServerEvents.recipes(event => {
        ...
        const qwNbt = "{ RepairCost:0, amts:[L;8L,8L,1L,28L,8L,396L,270L,16L,91L,16L,203L,1L,44L,4L,444L,8L,17L,68L],display:{Nome:'{\"texto\":\"Pacote de componente principal de tecelagem quântica\"}'}, ic:1631L, internalCurrentPower:20000.0d,chaves:[{\"#c\":\" ae2:i \",id:\" gtceu:trinium_frame \"},{\"#c\":\" ae2:i \",id:\" gtceu:superconducting_coil \"},{\"#c\":\" ae2:i \",id:\" gtceu:me_molecular_assembler_io \"},{\"#c\":\" ae2:i \",id:\" gtceu:advanced_computer_casing \"},{\"#c\":\" ae2:i \",id:\" gtlcore:molecular_casing \"},{\"#c\":\" ae2:i \",id:\" gtlcore:iridium_casing \"},{\"#c\":\" ae2:i \",id:\" gtceu:fusion_glass \"},{\"#c\":\" ae2:i \",id:\" gtceu:naquadah_alloy_frame \"},{\"#c\":\" ae2:i \",id:\" gtceu:high_power_casing \"},{\"#c\":\" ae2:i \",id:\" gtceu:hsse_frame \"},{\"#c\":\" ae2:i \",id:\" gtceu:me_craft_pattern_container \"},{\"#c\":\" ae2:i \",id:\" gtlsupb:quantum_weaver \"},{\"#c\":\" ae2:i \",id:\" gtceu:assembly_line_grating \"},{\"#c\":\" ae2:i \",id:\" gtlcore:hyper_mechanical_casing \"},{\"#c\":\" ae2:i \",id:\" gtceu:assembly_line_casing \"},{\"#c\":\" ae2:i \",id:\" gtlcore:advanced_assembly_line_unit \"},{\"#c\":\" ae2:i \",id:\" gtceu:europium_frame \"},{\"#c\":\" ae2:i \",id:\" gtceu:large_scale_assembler_casing \"}]}";
