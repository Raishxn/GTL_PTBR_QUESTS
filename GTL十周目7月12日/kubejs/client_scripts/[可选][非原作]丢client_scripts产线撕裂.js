...
JEIEvents.addItems(event => {
    console.log('Registrando pacote de componentes AE personalizados com JEI...')
    // --- 批量注册无限流体单元 ---
    ...
    event.add(Item.of('gtladditions:macro_atomic_resonant_fragment_stripper', '{BlockEntityTag:{astralArrayCount:382},display:{Lore:[\'"O macroátomo que desbloqueou a teoria da realização do paradoxo preencheu 382 arranjos estelares. Quando usado como hospedeiro, pode ser obtido combinando-se com a bobina eterna. Longo. Paralelo MAX "\']}}'))
    event.add(Item.of('gtceu:configurable_maintenance_hatch', '{BlockEntityTag:{ durationMultiplier:2.0f, maintenanceProblems:127b },display:{Lore:[\'"O multiplicador demorado é 2,0x. Ele foi mantido uma vez. Coloque-o com cuidado. O status de manutenção e o multiplicador demorado serão redefinidos após a mineração"\']}}'))
    event.add(Item.of('gtceu:auto_configuration_maintenance_hatch', '{BlockEntityTag: {durationMultiplier:2.0f},display:{Lore:[\'"O multiplicador demorado é 2,0x. Coloque-o com cuidado. O multiplicador demorado será redefinido após a mineração"\']}}'))
    // --- 批量注册无限原木单元 ---
    ...
    // 究极宇宙探测
    event.add(packed_infinity_cell('Pacote de componentes de exploração espacial', 'f', ['gtceu:cosmic_element', 'gtceu:starlight', 'gtceu:heavy_lepton_mixture']))

    // 究极集气
    event.add(packed_infinity_cell('Pacote de componentes de coleta de gás', 'f', ['gtceu:air', 'gtceu:liquid_air', 'gtceu:nether_air', 'gtceu:liquid_nether_air', 'gtceu:ender_air', 'gtceu:liquid_ender_air']))

    // 究极木石化
    event.add(packed_infinity_cell('Pacote de componentes de madeira petrificada', 'f', ['gtceu:ethanol','gtceu:naphthalene', 'gtceu:octane', 'gtceu:ethane', 'gtceu:propane', 'gtceu:butane', 'gtceu:toluene', 'gtceu:benzene', 'gtceu:butadiene', 'gtceu:butene', 'gtceu:propene', 'gtceu:ethylene', 'gtceu:methanol', 'gtceu:absolute_ethanol', 'gtceu:methane', 'gtceu:methyl_acetate', 'gtceu:acetic_acid', 'gtceu:carbon', 'gtceu:creosote', 'gtceu:carbon_monoxide', 'gtceu:dimethylbenzene', 'gtceu:acetone', 'gtceu:phenol']))

    // 鸿蒙元件包
    event.add(packed_infinity_cell_if('Pacote de componentes Hongmeng', homoitem, homofluid))

    //脆弱工具元件包
    event.add(packed_infinity_cell('Pacote de componentes de ferramentas frágeis','i',['fragile_tool:fragile_file', 'fragile_tool:fragile_hammer', 'fragile_tool:fragile_mallet', 'fragile_tool:fragile_wrench', 'fragile_tool:fragile_wire_cutter', 'fragile_tool:fragile_crowbar', 'fragile_tool:fragile_saw', 'fragile_tool:fragile_screwdriver','fragile_tool:fragile_knife','fragile_tool:fragile_mortar']))

    //通用电路板元件包
    event.add(packed_infinity_cell('Pacote de componentes de placa de circuito universal','i',['kubejs:ulv_universal_circuit', 'kubejs:lv_universal_circuit', 'kubejs:mv_universal_circuit', 'kubejs:hv_universal_circuit', 'kubejs:ev_universal_circuit', 'kubejs:iv_universal_circuit', 'kubejs:luv_universal_circuit', 'kubejs:zpm_universal_circuit', 'kubejs:uv_universal_circuit', 'kubejs:uhv_universal_circuit', 'kubejs:uev_universal_circuit', 'kubejs:uiv_universal_circuit', 'kubejs:uxv_universal_circuit', 'kubejs:opv_universal_circuit', 'kubejs:max_universal_circuit']))
    ...
    if (Platform.isLoaded('gtl_extend')) {
        ...
        event.add(packed_infinity_cell_if('Pacote de componentes do buraco negro', homoitem, bhmdo))
    }
