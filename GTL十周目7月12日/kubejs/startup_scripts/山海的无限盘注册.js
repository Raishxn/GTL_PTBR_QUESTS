...
StartupEvents.modifyCreativeTab("expatternprovider:tab_main", e => {
    ...
    function shanhai$buildGtceuAllFluidSDA() {
        ...
        return DShanhaiNBTAPI.buildSDAFromList(
            entries,
            'Versão de fluxo de matriz infinita totalmente fluida GTCEu',
            ['§7Reexportação temporária: retém apenas fluido de origem GTCEu', '§7bloqueou o fluxo_* ID do fluido', 'Tipo de fluido §7: §e' + entries.length],
            []
        );
    }
    ...
    try {
        ...
        console.error('[Shanhai SDA] Falha na geração de matriz infinita totalmente fluida do GTCEu:' + err);
    }
