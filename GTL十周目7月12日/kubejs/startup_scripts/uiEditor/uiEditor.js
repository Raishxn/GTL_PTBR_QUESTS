...
(function() {
	...
	if (!global.uiEditor.machinesToModify) {
		console.warn('[uiEditor] Não foi possível encontrar global.uiEditor.machinesToModify, o processo foi encerrado')
	...
	StartupEvents.postInit(() => {
		...
		console.log('A desduplicação da matriz foi concluída, o conteúdo é o seguinte:')
		...
		console.log('[uiEditor] Todas as modificações concluídas')
	})
})()