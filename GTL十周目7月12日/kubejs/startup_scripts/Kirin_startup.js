...
;(function(){
	...
	if (KIRIN_CONFIG) {
		...
		console.error('Produto pessoal da Kirin - o script de inicialização não detectou o arquivo de configuração, verifique a instalação!')
		global.kirin = {
			isLoaded: false,
    ...
    if(global.kirin.enableSafeFixes){
        ...
        if (mat.hasProperty(PropertyKey.FLUID)) return;
