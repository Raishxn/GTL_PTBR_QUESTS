ServerEvents.recipes((event) => {
    ...
    gtr.assembly_line("kubejs:uv_primitive_dragon_egg_energy")
        ...
        .inputFluids("gtceu:darmstadtium 10000", "gtceu:soldering_alloy 100000")
    ...
    gtr.assembly_line("kubejs:uhv_primitive_dragon_egg_energy")
        ...
        .inputFluids("gtceu:neutronium 10000", "gtceu:soldering_alloy 100000")
    ...
    gtr.assembly_line("kubejs:uev_primitive_dragon_egg_energy")
        ...
        .inputFluids("gtceu:quantanium 10000", "gtceu:soldering_alloy 100000")
    ...
    gtr.assembly_line("kubejs:uiv_primitive_dragon_egg_energy")
        ...
        .inputFluids("gtceu:adamantium 10000", "gtceu:soldering_alloy 100000")
