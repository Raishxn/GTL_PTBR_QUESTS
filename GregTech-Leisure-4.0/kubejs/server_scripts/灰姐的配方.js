ServerEvents.recipes((event) => {
    ...
    gtr.precision_assembler("greythings:fast_infinity_cell") //高速无限盘组装
        .itemInputs("64x kubejs:zero_point_module_fragments",
                    "gtlcore:item_infinity_cell",
                    "gtlcore:fluid_infinity_cell",
                    "12x kubejs:entangled_singularity"
        )
        .inputFluids("gtceu:mutated_living_solder 1440")
        .itemOutputs("gtlcore:fast_infinity_cell")
