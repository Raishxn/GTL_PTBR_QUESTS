...
StartupEvents.registry("item", event => {
    ...
    tiers.forEach((universal_circuit) => {
        event.create(universal_circuit + "_universal_circuit")
            ...
            .displayName(universal_circuit.toUpperCase() + "Placa de circuito universal")
            .tooltip("§7uma placa de circuito geral")
    })
    ...
    event.create("hui_circuit_1")
        .tooltip(Component.literal("§793015-T operações de ponto flutuante/segundo"))
    event.create("hui_circuit_2")
        .tooltip(Component.literal("Unidade de processamento§776M"))
    event.create("hui_circuit_3")
        .tooltip(Component.literal("Algoritmo RSA inválido §7"))
    event.create("hui_circuit_4")
        .tooltip(Component.literal("§756º Mersenne Prime"))
    event.create("hui_circuit_5")
        .tooltip(Component.literal("Paradoxo §7"))
