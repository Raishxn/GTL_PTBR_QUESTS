...
function validateItemFormat(itemStr) {
    ...
    // 常见物品格式：
    // 1. "数量x 物品ID"como"4x minecraft:iron_ingot"
    // 2. "物品ID"como"minecraft:iron_ingot"（默认1个）
    // 3. "标签#标签名"como"#forge:ingots/iron"
...
function validateFluidFormat(fluidStr) {
    ...
    // 常见流体格式：
    // 1. "流体ID 数量"como"minecraft:water 1000"
    // 2. "流体ID"como"minecraft:water"（可能默认1mb）
